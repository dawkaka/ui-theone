...
export const Rocket: React.FC<{ recieving: boolean }> = ({ recieving }) => {
    return (
        <svg width="70" height="70" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: recieving ? "rotate(180deg)" : "" }}>
            ...
            <path d="M19.5 3.15089C19.3688 2.89994 19 2.97322 19 3.28761C19 3.49455 19.2173 3.71689 19.4652 3.98428C19.4749 3.99478 19.4875 4 19.5 4C19.5125 4 19.5252 3.99478 19.5349 3.98428C19.7837 3.71589 20 3.49461 20 3.28761C20 2.97216 19.6302 2.90183 19.5 3.15089Z" fill="#0F34B7" fill-opacity="0.9" />
            ...
            <path d="M16.5 8.15089C16.3688 7.89994 16 7.97322 16 8.28761C16 8.49455 16.2173 8.71689 16.4652 8.98428C16.4749 8.99478 16.4875 9 16.5 9C16.5126 9 16.5251 8.99478 16.5348 8.98428C16.7837 8.71589 17 8.49461 17 8.28761C17 7.97216 16.6302 7.90183 16.5 8.15089V8.15089Z" fill="#0F34B7" fill-opacity="0.9" />
